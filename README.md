...
* `src`: Includes additional code to be imported
...
The main directory includes the `TrainModels.py` script, which can be run to reproduce all the paper's main results.  
Such a script is required by OceanCode. This script is a 1:1 copy of the [TrainModels.ipynb](TrainModels.ipynb) notebook. 
